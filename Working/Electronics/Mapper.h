...
sub_state_t.mode pressure_protect(float pressure, float fdepth);
sub_state_t.mode temp_protection(float temperature);
sub_state_t.mode leak_protection(int leakState);
sub_state_t.mode collision_protection(float x_acc, float y_acc, float z_acc);
